...
> Brooke, E. S. (2026). *The Structure of Admissible Physics: Non-Closure, Gauge Origin, Capacity Counting, and the 61-Type Partition*. Version v5.3-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18604839

**BibTeX:**

```bibtex
@misc{brooke_paper2_2026,
...
The DOI `10.5281/zenodo.18604839` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
