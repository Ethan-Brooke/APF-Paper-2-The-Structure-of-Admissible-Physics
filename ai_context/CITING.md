...
> Brooke, E. S. (2026). *The Structure of Admissible Physics: Non-Closure, Gauge Origin, Capacity Counting, and the 61-Type Partition*. Version v5.3-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18439274
...
The DOI `10.5281/zenodo.18439274` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
