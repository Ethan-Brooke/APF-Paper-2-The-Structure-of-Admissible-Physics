# Claims Ledger — Paper 2 (main v7.0 · Supplement I v5.1 · Supplement II v1.0)
...
skeptical reviewer would attack. "Supp I" = The Classification Core (v5.1);
...
| 6 | Canonical F6 = full-system non-degeneracy (10/5); electromagnetic completeness is an INDEPENDENT declared assumption doing the work of removing the 42-DOF near-miss | declared input, point-of-use | Supp I §seven filters (F6) | `check_L_F6_not_from_EC`; `release_audit/near_misses.csv` | reject the assumption → the stripped generation survives below the SM |
