...
The reproducibility contract in Technical Supplement I (v5.4) names five audit files a complete release must carry. They live in [`release_audit/`](release_audit/), generated by `python fermion_scan_standalone.py --emit-audit` at this release's version lock:
...
├── fermion_scan_standalone.py             ← THE CANONICAL SCAN EXECUTABLE (v4.3; emits release_audit/)
├── docs/
...
├── Paper_2_Structure_of_Admissible_Physics_v7.3.tex                          ← the paper
├── Paper_2_Structure_of_Admissible_Physics_Supplement_v5.4.tex               ← Technical Supplement I — The Classification Core
